...
This script:
1. Loads or generates transition data for multiple portal environments
...
from src.utils.plotting import create_eigenvector_visualization_report
from src.utils.envs import get_canonical_free_states
from src.data_collection import generate_portal_environments_data
...
def run_eigendecomposition_analysis(
    ...
    Args:
        ...
        smoothing: Smoothing parameter for transition matrix computation
        normalize: Whether to row-normalize the transition matrix
...
def main():
    ...
    parser.add_argument("--base-env", type=str, default="GridRoom-4",
        help="Base environment name (default: GridRoom-4)")
    parser.add_argument("--num-envs", type=int, default=10,
        help="Number of portal environments (default: 10)")
    parser.add_argument("--num-portals", type=int, default=10,
    ...
    parser.add_argument("--output-dir", type=str, default="experiments/01/results",
    ...
    parser.add_argument("--wall-color", type=str, default="gray",
        help="Color for wall/obstacle cells in visualizations (default: gray)")
    parser.add_argument("--num-eigenvectors", type=int, default=6,
