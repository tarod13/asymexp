...
echo "  Potential power: $POTENTIAL_POWER"
echo "  Potential base : $POTENTIAL_BASE"
echo "========================================"
...
export MIN_GOAL_DISTANCE START_STATE GOAL_STATE NUM_EIGENVECTORS N_STEP_TD POTENTIAL_MODE POTENTIAL_TEMP POTENTIAL_DELTA POTENTIAL_POWER POTENTIAL_BASE ALLO_MODEL_DIR
