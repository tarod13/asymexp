...
#SBATCH --mem=8G
#SBATCH --array=0-999
#SBATCH --output=logs/batch_lr_sweep_%a.out
#SBATCH --error=logs/batch_lr_sweep_%a.err
...
#
# Usage:
#   sbatch scripts/batch_lr_sweep.sh                    # on SLURM
#   bash scripts/batch_lr_sweep.sh <task_id>            # local (single run)
# =============================================================================
