...
def create_update_function(encoder, args):
    ...
    def update_encoder(
        ...
        # Clip encoder gradients only (dual/EMA parameters should not be clipped)
        max_norm = 1.0
        ...
        grads = {
            ...
            'dual_x_norm': grads['dual_x_norm'],
            'dual_y_norm': grads['dual_y_norm'],
            'dual_xy_phase': grads['dual_xy_phase'],
            'dual_x_orth_real': grads['dual_x_orth_real'],
            'dual_x_orth_imag': grads['dual_x_orth_imag'],
            'dual_y_orth_real': grads['dual_y_orth_real'],
            'dual_y_orth_imag': grads['dual_y_orth_imag'],
        }
